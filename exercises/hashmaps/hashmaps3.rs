...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        match scores.get(&team_1_name) {
            None => scores.insert(team_1_name, Team {
        ...
        match scores.get(&team_2_name) {
            None => scores.insert(team_2_name, Team {
                goals_scored: team_2_score,
                goals_conceded: team_1_score
            }),
            Some(team) => {
                scores.insert(team_2_name, Team {
                    goals_scored: team_2_score + team.goals_scored,
                    goals_conceded: team_1_score + team.goals_conceded
                })
            }
        };
    }
